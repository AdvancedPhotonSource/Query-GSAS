% Recall@k bar chart grouped by category
\begin{figure}[htbp]
\centering
\begin{tikzpicture}
\begin{axis}[
...
\end{axis}
\end{tikzpicture}
\caption{Retrieval performance on the 40-question evaluation set, broken
  down by query category.
  Recall@$k$ measures whether the ground-truth source page appears
